...
# (dev workspaces), which has NO profile/* access. Discover needs source
...
locals {
  ...
  # C4 (DevOps review): discoverer needs source-DB creds (profile/* secrets)
  # to inspect the live production schema. Use the runner-instance role,
