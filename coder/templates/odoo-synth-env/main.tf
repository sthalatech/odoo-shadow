...
data "coder_workspace_preset" "default_profile" {
  ...
  description = "Odoo + local Postgres hydrated from the newest masked dump, with the erp.life.in addons repo live-mounted for development."
  parameters = {
    ...
    repo_url        = "https://github.com/IshaFoundationIT/erp.life.in"
